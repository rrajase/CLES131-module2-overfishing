...
We also begin to explore how to manipulate tabular data using relational database concepts. Instead of working with independent dataframes, as in Module 1, we will be working with a large relational database consisting of tables of different shapes and sizes, but are related through one or more IDs.
...
The above function loads all 60 tables of this database!In order to reproduce an updated version of Fig. 3a from Worm et al. 2006, you will need to understand the structure of the database and how the tables are related. 
...
### Q1 (1 point)
What are the two primary metadata tables, and how are they related?
